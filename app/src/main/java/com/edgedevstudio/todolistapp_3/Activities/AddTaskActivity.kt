...
import com.edgedevstudio.todolistapp_3.ViewModel.AddTaskViewModel
import com.edgedevstudio.todolistapp_3.ViewModel.AddTaskViewModelFactory
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (intent != null && intent.hasExtra(EXTRA_TASK_ID)) {
            ...
            if (mTaskId == DEFAULT_TASK_ID) { //implement saved instance state to avoid getting IntentExtra. Leads to a More Optimised App!
                ...
                viewModel.task.observe(this, androidx.lifecycle.Observer { taskEntry ->
...
val taskEntryLiveData = appDatabase.taskDao().loadTaskById(mTaskId)
                taskEntryLiveData.observe(this, Observer {
                    taskEntryLiveData.removeObservers(this)
                    populateUI(it)
                })
*
* */